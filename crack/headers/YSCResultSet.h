...
@class NSDictionary, NSMutableDictionary, NSString, YSCDatabase, YSCStatement;

@interface YSCResultSet : NSObject
{
    NSMutableDictionary *_columnNameToIndexMap;
    YSCDatabase *_parentDB;
    NSString *_query;
    YSCStatement *_statement;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) YSCStatement *statement; // @synthesize statement=_statement;
@property(retain) NSString *query; // @synthesize query=_query;
@property(retain, nonatomic) YSCDatabase *parentDB; // @synthesize parentDB=_parentDB;
- (void).cxx_destruct;
