...
@class NSMutableData, NSProgress, NSString, NSURL, YSCURLSessionManager;
...
@property(nonatomic) __weak YSCURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
