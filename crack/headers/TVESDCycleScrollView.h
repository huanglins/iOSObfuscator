...
@interface TVESDCycleScrollView : UIView <UICollectionViewDataSource, UICollectionViewDelegate>
{
    _Bool _infiniteLoop;
    _Bool _autoScroll;
    ...
    id <TVESDCycleScrollViewDelegate> _delegate;
...
@property(nonatomic) __weak id <TVESDCycleScrollViewDelegate> delegate; // @synthesize delegate=_delegate;
