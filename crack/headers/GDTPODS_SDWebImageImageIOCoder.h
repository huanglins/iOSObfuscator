...
@interface GDTPODS_SDWebImageImageIOCoder : NSObject <SDWebImageProgressiveCoder>
{
...
+ (long long)gdtsd_imageOrientationFromImageData:(id)arg1;
...
- (id)gdtsd_decompressedAndScaledDownImageWithImage:(id)arg1;
- (id)gdtsd_decompressedImageWithImage:(id)arg1;
