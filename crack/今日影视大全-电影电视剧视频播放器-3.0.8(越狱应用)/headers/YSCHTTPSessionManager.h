...
@class NSURL, YSCHTTPRequestSerializer<YSCURLRequestSerialization>, YSCHTTPResponseSerializer<YSCURLResponseSerialization>, YSCSecurityPolicy;

@interface YSCHTTPSessionManager : YSCURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    YSCHTTPRequestSerializer<YSCURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) YSCHTTPRequestSerializer<YSCURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) YSCSecurityPolicy *securityPolicy; // @dynamic securityPolicy;
@property(retain, nonatomic) YSCHTTPResponseSerializer<YSCURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
