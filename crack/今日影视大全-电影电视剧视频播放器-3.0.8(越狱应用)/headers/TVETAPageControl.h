...
@interface TVETAPageControl : UIControl
{
    ...
    id <TVETAPageControlDelegate> _delegate;
...
@property(nonatomic) id <TVETAPageControlDelegate> delegate; // @synthesize delegate=_delegate;
