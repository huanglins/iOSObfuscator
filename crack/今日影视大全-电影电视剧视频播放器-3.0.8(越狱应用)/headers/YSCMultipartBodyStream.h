...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, YSCHTTPBodyPart;

@interface YSCMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    YSCHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) YSCHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
