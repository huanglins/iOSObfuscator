...
@class NSCache, NSFileManager, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, YSCImageCacheConfig;

@interface YSCImageCache : NSObject
{
    NSFileManager *_fileManager;
    YSCImageCacheConfig *_config;
    NSCache *_memCache;
...
@property(readonly, nonatomic) YSCImageCacheConfig *config; // @synthesize config=_config;
- (void).cxx_destruct;
