...
#import "LZMChangeSourceViewDelegate.h"
#import "LZMFProjManagerDelegate.h"
#import "LZMNetStatusViewDelegate.h"
#import "LZMReportErrorViewDelegate.h"
#import "UIGestureRecognizerDelegate.h"

@class LZMButton, LZMChangeSourceView, LZMFProjDeviceView, LZMFProjectBGView, LZMNetStatusView, LZMPlayerActivity, LZMPlayerButton, LZMPlayerModel, LZMPlayerShieldView, LZMPlayerSpeedView, LZMReportErrorView, LZMSlider, LZMYChooseChannelView, NSString, UIImageView, UILabel, UIProgressView, UITapGestureRecognizer;

@interface LZMLivePlayerControlView : UIView <UIGestureRecognizerDelegate, LZMChangeSourceViewDelegate, LZMNetStatusViewDelegate, LZMReportErrorViewDelegate, LZMFProjManagerDelegate>
{
    _Bool _showing;
    _Bool _shrink;
    _Bool _cellVideo;
    ...
    LZMButton *_sourceBtn;
    LZMButton *_changeChannelBtn;
    LZMButton *_lockBtn;
    ...
    LZMYChooseChannelView *_chooseChannelView;
    LZMChangeSourceView *_changeSourceView;
    LZMReportErrorView *_reportErrorView;
    LZMNetStatusView *_netStatusView;
    LZMPlayerShieldView *_shieldView;
...
@property(retain, nonatomic) LZMPlayerShieldView *shieldView; // @synthesize shieldView=_shieldView;
...
@property(retain, nonatomic) LZMChangeSourceView *changeSourceView; // @synthesize changeSourceView=_changeSourceView;
@property(retain, nonatomic) LZMYChooseChannelView *chooseChannelView; // @synthesize chooseChannelView=_chooseChannelView;
...
@property(retain, nonatomic) LZMButton *changeChannelBtn; // @synthesize changeChannelBtn=_changeChannelBtn;
@property(retain, nonatomic) LZMButton *sourceBtn; // @synthesize sourceBtn=_sourceBtn;
...
- (void)lzmdelegate_ChooseChannelWithModel:(id)arg1;
- (void)lzmdelegate_ChangeSourceWithUrlModel:(id)arg1;
...
- (void)lzm_interfaceOrientation:(long long)arg1;
- (void)setLivingConstraint;
- (void)setPlayBackConstraint;
...
- (void)changeChannelAction:(id)arg1;
- (void)changeSourceAction:(id)arg1;
