...
@class NSArray, NSLock, NSMutableDictionary, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration, YSCNetworkReachabilityManager, YSCSecurityPolicy;
...
@interface YSCURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    ...
    id <YSCURLResponseSerialization> _responseSerializer;
    YSCSecurityPolicy *_securityPolicy;
    YSCNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) YSCNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) YSCSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
@property(retain, nonatomic) id <YSCURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
