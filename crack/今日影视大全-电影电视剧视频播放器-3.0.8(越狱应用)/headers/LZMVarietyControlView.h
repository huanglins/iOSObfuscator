...
@class LZMButton, LZMChooseSectionView, LZMFProjDeviceView, LZMFProjectBGView, LZMNetStatusView, LZMPlayerActivity, LZMPlayerButton, LZMPlayerModel, LZMPlayerSpeedView, LZMReplayView, LZMReportErrorView, LZMSlider, LZMVideoQualityView, LZMWebPlayView, NSString, UIButton, UIImageView, UILabel, UIProgressView, UITapGestureRecognizer;

@interface LZMVarietyControlView : UIView <UIGestureRecognizerDelegate, LZMNetStatusViewDelegate, LZMReportErrorViewDelegate, LZMVideoQualityViewDelegate, LZMYSelectProgramDelegate, LZMFProjManagerDelegate>
{
    _Bool _showing;
    _Bool _shrink;
    _Bool _cellVideo;
...
- (void)buildChooseSectionView:(id)arg1;
