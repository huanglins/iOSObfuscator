...
void modifyProjectName(NSString *projectDir, NSString *oldName, NSString *newName) {
    ...
    NSString *testsDirPath = [sourceCodeDirPath stringByAppendingString:@"Tests"];
    NSString *uiTestsDirPath = [sourceCodeDirPath stringByAppendingString:@"UITests"];
    ...
    if ([fm fileExistsAtPath:testsDirPath isDirectory:&isDirectory] && isDirectory) {
        renameFile(testsDirPath, [[projectDir stringByAppendingPathComponent:newName] stringByAppendingString:@"Tests"]);
    }
    if ([fm fileExistsAtPath:uiTestsDirPath isDirectory:&isDirectory] && isDirectory) {
        renameFile(uiTestsDirPath, [[projectDir stringByAppendingPathComponent:newName] stringByAppendingString:@"UITests"]);
    }
}
